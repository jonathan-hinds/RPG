...
namespace RPGClone.UI
{
    ...
    public sealed class MMOClassTrainerPresenter : MonoBehaviour
    {
        ...
        private void CreateOfferRow(MMOTrainerOfferEntry offer, int index)
        {
            ...
            CreateAbilityIcon(rowRect, offer);
        ...
        private void CreateAbilityIcon(RectTransform rowRect, MMOTrainerOfferEntry offer)
        {
            RectTransform icon = MMOUiFactory.CreateRect("Icon", rowRect);
            ...
            MMOAbilityDefinition ability = offer != null ? offer.Ability : null;
            MMOSlotView.Attach(icon.gameObject).Present(
                MMOAbilitySlotAdapter.Present(
                    ability,
                    usable: offer != null && CanTrain(offer),
